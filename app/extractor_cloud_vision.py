...
SYSTEM = (
    ...
    "Prefer literal numeric values and units as they appear in the image/table."
)
...
- If multiple SKUs/rows, choose the FIRST clearly indicated main part number near the top/main section; place the rest as physical rows if useful.
